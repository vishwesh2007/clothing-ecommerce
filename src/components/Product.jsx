  ...
  return (
    <div className="overflow-hidden flex flex-col justify-start items-center w-35 h-full cursor-pointer">
      <div className="relative overflow-hidden h-40 mb-1">
        <img src={product.image[0]} className=" ease-in-out transition-transform duration-200 hover:scale-110" alt="" />
        <p className="text-[10px] absolute top-2 bg-black/80 text-[#ffffff] px-1 py-[2px]">{product.subCategory}</p>
      </div>
